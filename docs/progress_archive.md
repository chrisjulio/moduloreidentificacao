# progress_archive.md — Histórico arquivado de sessões

> **Arquivo de histórico.** Conteúdo migrado do `progress.md` pela regra de
> repaginação (ver cabeçalho do `progress.md`). Somente consulta — a retomada de
> trabalho usa o `progress.md`. Mais novas no topo, como no original. Duas
> seções: o **Histórico de sessões** detalhado e os **Últimos passos arquivados**
> (resumos podados da seção "Estado atual" do `progress.md`, redundantes com o
> Histórico).
>
> **Repaginações (2026-06-27):**
> - **1ª:** migradas as sessões de **2026-06-06 e anteriores** (eras S1–S9 / D-08).
> - **2ª:** migrado o Histórico de **2026-06-10 e anteriores** (eras #174/W1 e
>   infra A0x) + os resumos antigos de "Último passo concluído" (2026-06-11 e
>   anteriores). Permanecem no `progress.md` a era pós-entrega (D-rounds,
>   release/DOI, E1/V1/V2) e o Histórico de **2026-06-11 em diante**.
...
## Últimos passos arquivados (resumos de "Estado atual")

> Resumos podados da seção "Último passo concluído" do `progress.md` (2026-06-11
> e anteriores). **Redundantes** com o Histórico acima — preservados por
> arquivamento, não por necessidade. A versão canônica de cada sessão é a
> entrada `### data` correspondente.
